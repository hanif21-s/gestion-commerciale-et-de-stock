...
<div class="my-3 p-6 bg-body rounded shadow-sm">
  <h3 class="border-bottom pb-2 mb-3">Ajout d'une nouvelle taxe</h3>
  <div class="mt-4">
    ...
    @endif
    <form style="width:65%;" method="post" action="{{route('taxes.ajouter')}}">
      @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Taux (%)</label>
